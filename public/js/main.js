...
(function ($) {
  ...
  /*   $('.object-custom-menu > li.has-mega-menu > a').on('click', function (e) {
    ...
    ====================================*/
        ...
        document.getElementById('donationAmount').style.fontSize = '6rem';
        document.getElementById('donationAmount').style.display = 'flex';
        document.getElementById('donationAmount').style.justifyContent = 'center';
        document.getElementById('donationAmountSign').style.fontSize = '2rem';
        document.getElementById('donationAmount').style.fontWeight = 'bold';
        document.getElementById('donationAmount').style.paddingTop = '3rem';
        document.getElementById('donationAmount').style.paddingBottom = '1rem';
